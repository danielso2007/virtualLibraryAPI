...
public abstract class SearchServiceImpl<E extends BaseEntity, ID extends Serializable, R extends IBaseRepository<E, ID>>
		extends BaseServiceImpl<E, ID, R>
		implements ISearchService<E, ID, R> {
	
	private static final String DIRECTION_DESC = "desc";
	private static final String ORDERBY = "orderby";

	public SearchServiceImpl(R repository) {
		super(repository);
	}
